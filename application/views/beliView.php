...
<div style="float:left; width:100%;">
 ...
 <div id="container" style="width:30%;height:20%;"> 
		<label>Tanggal Beli</label>
			
		<form id="start" action="/pos-kios/index.php/indexController/getDateBeliFilter" method="POST" >
		<input type="date" name="date" class="form-control">
	<input type="submit" name="submit" value="Apply Filter" />
	</form>
	
	</div>
	<div id="container" style="width:30%;height:50%;">
	<label>Tambah Data</label>
	<form id="start" action="/pos-kios/index.php/indexController/tambahPembelian" method="POST" >
    ...
    <table>
     ...
     <tr>
	 <td><?php echo $post->id_trans_pembelian; $no++;?></td>
		 ...
		 <td><?php echo '<form id="start" action="/pos-kios/index.php/indexController/editPembelian" method="POST" >';?>
         <?php echo '<input type="submit" name="';
		 echo $post->id_trans_pembelian;
		 echo '" value="Edit" />';?>
		 <?php echo '</form>';?>
		 <?php echo '<form id="start" action="/pos-kios/index.php/indexController/deletePembelian" method="POST" >';?>
         <?php echo '<input type="submit" name="';
		 echo $post->id_trans_pembelian;
		 echo '" value="Delete" />';?>
         <?php echo '</form>';?></td>
