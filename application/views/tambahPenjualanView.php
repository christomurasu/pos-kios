...
<form id="start" action="/pos-kios/index.php/indexController/prosesTambahPenjualan" method="POST" >
<?php
$provinsi = array();
...
?>
    ...
    <h4>Harga Jual : <input type="text" name="hargaJual" value="" /></h4><br>
	<h4>Tanggal Jual : 		<input type="date" name="tanggalJual" class="form-control" value=""></h4>
