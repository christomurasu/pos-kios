...
<form id="start" action="/pos-kios/index.php/indexController/prosesTambahPembelian" method="POST" >
<?php
$provinsi = array();
...
?>
    ...
    <?php } ?>
	<option value="inputManual">Input Barang Baru</option>
</select></h4><br>
<h4>Nama Barang Baru : <input type="text" name="namaBarangBaru" value="" /></h4><br>
    <h4>Jumlah : <input type="text" name="jumlahBarang" value="" /></h4><br>
    <h4>Harga Beli : <input type="text" name="hargaBeli" value="" /></h4><br>
	<h4>Tanggal Beli : 		<input type="date" name="tanggalBeli" class="form-control" value=""></h4>
